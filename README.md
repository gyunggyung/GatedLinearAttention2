...
현재 10B checkpoint의 GDN2/Mamba-3 비교 결과와 RULER 대기 상태는 [docs/current_eval_comparison_gdn2_mamba3.md](docs/current_eval_comparison_gdn2_mamba3.md)에 정리했습니다. 실험 중단 시점의 실패 원인, 잘한 점, 못한 점, 남은 가능성은 [docs/experiment_stop_summary_2026-06-21.md](docs/experiment_stop_summary_2026-06-21.md)에 정리했습니다. 더 쉬운 설명은 [docs/experiment_failure_easy_summary_2026-06-21.md](docs/experiment_failure_easy_summary_2026-06-21.md), 상세 사후 분석은 [docs/experiment_failure_detailed_analysis_2026-06-21.md](docs/experiment_failure_detailed_analysis_2026-06-21.md)에 따로 정리했습니다. 요약하면, 최종 10B checkpoint는 완료된 GDN2 Table 2 표준 평가에서 Gated DeltaNet-2를 이긴 항목이 없고, RULER에서도 GDN2를 이기지 못했습니다. Mamba-3 대비 일부 단일 항목 승리는 있었지만 의미 있는 전체 승리는 아닙니다.
